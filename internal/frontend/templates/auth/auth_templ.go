...
func AuthPage(title string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<body class=\"auth-container\"><!-- Floating Background Shapes --><div class=\"floating-shapes\"><div class=\"shape\"></div><div class=\"shape\"></div><div class=\"shape\"></div><div class=\"shape\"></div></div><!-- Main Container --><div class=\"min-h-screen flex items-center justify-center p-4 relative z-10\"><div class=\"w-full max-w-md\"><!-- Header --><div class=\"text-center mb-8 animate-fade-in\"><h1 class=\"text-4xl font-bold text-white mb-2\">Oplan</h1><p class=\"text-white text-opacity-80\">Welcome to your event management platform</p></div><!-- Auth Card --><div class=\"bg-white rounded-2xl shadow-2xl p-8 animate-bounce-in\"><!-- Toggle Buttons --><div class=\"flex bg-gray-100 rounded-xl p-1 mb-8\"><button id=\"signInTab\" onclick=\"switchTab('signIn')\" class=\"flex-1 py-3 px-4 rounded-lg font-medium transition-all duration-300 bg-primary text-white\">Sign In</button> <button id=\"signUpTab\" onclick=\"switchTab('signUp')\" class=\"flex-1 py-3 px-4 rounded-lg font-medium transition-all duration-300 text-gray-600 hover:text-gray-900\">Sign Up</button></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			if title == "Sign In" {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "<!-- Sign in Form Container --> ")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				...
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "<!-- Sign up Form Container --> ")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "</div><!-- Terms & Privacy --><div class=\"text-center mt-6 text-white text-opacity-80 text-sm\"><p>By continuing, you agree to our <a href=\"#\" class=\"text-white hover:text-opacity-100 underline\">Terms of Service</a> and <a href=\"#\" class=\"text-white hover:text-opacity-100 underline\">Privacy Policy</a></p></div></div></div></body>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			return nil
...
func SignInForm() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 5, "<div id=\"signInForm\" class=\"form-container active\"><!-- Step 1: Email/Phone --><div id=\"signInStep1\" class=\"step-container active\"><h2 class=\"text-2xl font-bold text-gray-900 mb-2\">Welcome back!</h2><p class=\"text-gray-600 mb-6\">Enter your email or phone number to continue</p><form id=\"signInForm1\"><div class=\"mb-6\"><label class=\"block text-sm font-medium text-gray-700 mb-2\">Email or Phone Number</label> <input type=\"text\" id=\"signInIdentifier\" required class=\"w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary transition-colors\" placeholder=\"Enter email or phone number\"></div><button type=\"submit\" class=\"w-full bg-primary text-white py-3 rounded-lg hover:bg-indigo-700 transition-colors font-medium mb-4\">Continue</button></form><div class=\"text-center\"><p class=\"text-sm text-gray-600\">Don't have an account? <button onclick=\"switchTab('signUp')\" class=\"text-primary hover:text-indigo-700 font-medium\">Sign up</button></p></div></div></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
...
func ErrorMessage(message string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/frontend/templates/auth/auth.templ`, Line: 273, Col: 39}
		}
...
func SuccessMessage(message string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/frontend/templates/auth/auth.templ`, Line: 284, Col: 41}
		}
...
func Dashboard(email string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/frontend/templates/auth/auth.templ`, Line: 306, Col: 43}
		}
