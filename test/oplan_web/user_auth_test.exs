defmodule OplanWeb.UserAuthTest do
  use OplanWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Oplan.Account
  alias OplanWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, OplanWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      OplanWeb.Endpoint.subscribe(live_socket_id)
